      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-6 text-warm-gray leading-relaxed">
          <p>
            ...
            agent with <strong>Sotheby&apos;s International Realty</strong> in
            Greenwich, Connecticut. With <strong>more than 40 years</strong> of
          ...
          <p>
            ...
            <strong>Stamford, Fairfield County, and Westchester County</strong>,
          ...
          <p>
            ...
            <strong>1 Pickwick Plaza, Greenwich, CT 06830</strong>. The
          ...
          <div className="bg-cream p-8 mt-8 border-l-4 border-gold">
            <h3 className="font-serif text-xl text-navy mb-2">
              Get in Touch
            </h3>
            <p className="text-warm-gray mb-4">
              Ready to buy or sell in Greenwich? Martha would love to hear from
              you.
            </p>
